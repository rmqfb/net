...
inwon = new Vector(); // 벡터에서 제너릭을 제거하면 모든 타입 수용
serverStart();
...
server.setMsg("["+nickName+"] 님이 입장 하셨습니다."); // 자동 생성된 메소드로 가기 위한 단축키 CTRL + 마우스 클릭
...
ex.printStackTrace();
}finally{  // finally 는 에러가 나든 정상 종료든 반드시 거쳐야 하는 블록
